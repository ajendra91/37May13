...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(customDetailsService).passwordEncoder(fun());
	}
	...
	public void configure(WebSecurity web) throws Exception {
		...
		.antMatchers("/search").antMatchers("/hotel").antMatchers("/categories")
				...
				.antMatchers("/search/hotels/**").antMatchers("/scripts/**")
				.antMatchers("/styles/**").antMatchers("/images/**")
				.antMatchers("/login").antMatchers("/bookingpage")
